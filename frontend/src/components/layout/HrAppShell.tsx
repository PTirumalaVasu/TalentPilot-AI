 ...
 * the user menu -- unchanged in position/behavior (AC2). */
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 font-sans">
      ...
      <aside
        ...
        className={
          'fixed inset-y-0 left-0 z-40 flex w-56 shrink-0 transform flex-col border-r border-gray-200 bg-white transition-transform duration-200 md:static md:translate-x-0 ' +
      ...
      >
        <div className="flex items-center justify-between border-b border-gray-100 px-5 py-5">
          ...
          <button
            type="button"
            onClick={() => setMobileNavOpen(false)}
            className="text-xl text-gray-400 hover:text-gray-600 md:hidden"
